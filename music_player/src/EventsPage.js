            ...
            <div>
                <div className='row'>
                    <div className='col'>
                        ...
                        {this.props.infoDataLoaded ? <h3>Find {this.props.music.artists[0].strArtist}'s upcoming events</h3> : null}
                        <div className='date-container'>
                            ...
                            <button className='events-button' onClick={this.onSubmit} ><i className="fa fa-search " aria-hidden="true"></i></button>
                        </div>
                    </div>
                </div>
                {this.state.eventDataLoaded ? <div className='event-container row'>
