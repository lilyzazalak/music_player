...
class VideoPage extends Component {
    render(){
        let musicVid = this.props.videoDataLoaded ? this.props.video.mvids.map((video, i) =>{
            return(video.strMusicVid.split('='))
          }) : null
                ...
                <div className='row'>
                    <div className='col'>
                        ...
                        {this.props.infoDataLoaded ? 
                            <h3>
                                Click Here to load {this.props.info.artists[0].strArtist}'s music videos
                            </h3> 
                        : null}
                    </div>
                </div>
